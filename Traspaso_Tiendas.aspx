<%@ Page Title="" Language="C#" MasterPageFile="~/Administracion.master" AutoEventWireup="true" CodeFile="Traspaso_Tiendas.aspx.cs" Inherits="Traspaso_Tiendas" %>
                        ...
                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                            <ContentTemplate>
                                <asp:GridView runat="server" ID="GridInvetarioProductos" ShowHeaderWhenEmpty="True"
                                    ...
                                    OnRowUpdating="GridTraspasar" EditRowStyle-ForeColor="#444444" ShowFooter="true"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Existencia" SortExpression="cantidadExistencia">
                                            <EditItemTemplate>
                                                <asp:TextBox runat="server" Height="30px" CssClass="ancho100px" Text='<%# Eval("cantidadExistencia","{0:N3}") %>' ID="txtCantidadProductos"></asp:TextBox>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Stock Min" SortExpression="cantidadMinima" >
                                            <EditItemTemplate>
                                                <asp:Label runat="server" Text='<%# Bind("cantidadMinima","{0:N3}") %>' ID="txtMin"></asp:Label>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="Stock Max" SortExpression="cantidadMaxima" >
                                            <EditItemTemplate>
                                                <asp:Label runat="server" Text='<%# Bind("cantidadMaxima","{0:N3}") %>' ID="txtMax"></asp:Label>
                                            </EditItemTemplate>
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField ShowHeader="False" ItemStyle-CssClass="text-center">
                                            ...
                                            <ItemTemplate>
                                                <asp:Button runat="server" Text="Traspasar Produdcto (s)" CssClass="btn-warning" CommandName="Edit" CausesValidation="False" ID="Button1"></asp:Button>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
